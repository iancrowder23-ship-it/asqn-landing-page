...
<svelte:head>
  <title>Create Event -- ASQN 1st SFOD</title>
</svelte:head>
...
<div class="max-w-2xl mx-auto px-4 py-8">
  ...
  <h1 class="text-2xl font-bold text-ranger-tan font-tactical mb-6">Create Event</h1>
  ...
  <form method="POST" use:enhance class="space-y-5">
    <div>
      ...
      <input
        ...
        placeholder="Operation name or event title"
      />
      {#if $errors.title}
